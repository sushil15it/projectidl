...
<body>
    ...
    <div class="box glass">
            <div class="profile">
                <div class="img"><img src="/projectidl/login/loginphp/image/<?php echo $_SESSION["rowuser"]["icon"];?>" alt=""></div>
                <div class="detail">
            ...
            <table>
                    ...
                    <tr><td>
                        <p>id: </p>
                        </td><td> <span id="libid"><?php echo $_SESSION["libraryId"]; ?></span>
                        </td>   
                    </tr>
                    <tr><td>
                        <p>librarian name: </p>
                        </td><td>    <span id="usernameT"><?php echo $_SESSION["rowuser"]["name"]; ?></span>
                        </td>    
                    </tr>
                    <tr><td>
                        <p>email: </p>
                    ...
                    <tr><td>
                        ...
                        <td> <span id="mobileT"><?php echo $_SESSION["rowuser"]["MNo"]; ?>
                        </span></td>
                        
                    </tr>
                    <tr><td>
                        <p>librarian qualification: </p>
                        </td>
                        <td> <span id="HiQT"><?php echo $_SESSION["rowuser"]["HiQ"]; ?>
                        </span></td>
                        
                    </tr>
                    <tr><td>
                        <p>college/school/organisation:  </p> 
                        </td>
                        <td> <span id="OrgName"><?php echo $_SESSION["OrgName"]; ?>
                        </span></td>
                    ...
                    <tr><td>
                        ...
                        <td> <span id="BookNum"><?php echo $_SESSION["BookNum"];?>
                                          </span></td>          
                    </tr>
                </table>
            ...
            <div id="popup2">
                <div id="adbform2">   
                     <p onclick="closepopup2()" id=clpopup2>x</p>
                      ...
                      <form id="form"  action="/projectidl/librarian/profileedit.php" method="POST" enctype="multipart/form-data">
                      <div class="error" id="error" style="display: none;">this is an error massage!</div>

                      <div style="display: flex;">
                         <div><div> <p class="headp">library name</p>
                      <div class="inptbx2">
                      <input type="text" id="libname"name="libname"required>
                          </div> 
                       </div>
                     <div> <p class="headp">librarian name</p>
                          <div class="inptbx2">
                      ...
                      <input type="tel" id="mobile"name="mobile"pattern="[0-9]{10}" required>
                          ...
                          <div> <p class="headp">highest qualification</p>
                          <div class="inptbx2">
...
var libname=document.getElementById("libNameT").innerText;
