...
<nav>
        ...
        <div class="menu" id="s2">
            <ul>
                ...
                <li id="bookbank">
                    <a href="bookbank.php">book database</a>
                </li>
                <li id="bookisue">
                    <a href="bookisue.php">book issue</a>
                </li>

                <li id="member">
                    <a href="stdlist.php">member</a>
                </li>
        ...
        <div class="dropdown login">
            <?php
            $icon=$_SESSION["rowuser"]["icon"];
            
            ?>
            <button class="dropbtn"><?php echo'<img src="/projectidl/login/loginphp/image/'. $icon.'   " alt="">'?> <i class="fa fa-caret-down"></i>
                </button>
            <div class="dropdown-content" style="margin-left: -60px;">
                <a id="profile" href="profile.php">View Profile</a>
